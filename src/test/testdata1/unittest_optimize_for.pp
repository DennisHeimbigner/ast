...
message .protobuf_unittest_optimize.TestOptimizedForSize {
  ...
  extensions .protobuf_unittest_optimize.TestOptimizedForSize.$extensions.176 {
  extensionrange 1000 to 536870911
  }
  extend .protobuf_unittest_optimize.TestOptimizedForSize.$extend.177 {
...
message .protobuf_unittest.TestAllExtensions {
  extensions .protobuf_unittest.TestAllExtensions.$extensions.163 {
  extensionrange 1 to 536870911
  }
}
extend .protobuf_unittest.$extend.164 {
...
message .protobuf_unittest.TestNestedExtension {
  extend .protobuf_unittest.TestNestedExtension.$extend.165 {
...
message .protobuf_unittest.TestRequired {
  ...
  extend .protobuf_unittest.TestRequired.$extend.166 {
...
message .protobuf_unittest.TestEmptyMessageWithExtensions {
  extensions .protobuf_unittest.TestEmptyMessageWithExtensions.$extensions.167 {
  extensionrange 1 to 536870911
  }
}
message .protobuf_unittest.TestMultipleExtensionRanges {
  extensions .protobuf_unittest.TestMultipleExtensionRanges.$extensions.168 {
  extensionrange 42 to 536870911
  }
  extensions .protobuf_unittest.TestMultipleExtensionRanges.$extensions.169 {
  extensionrange 4143 to 4243
  }
  extensions .protobuf_unittest.TestMultipleExtensionRanges.$extensions.170 {
...
message .protobuf_unittest.TestPackedExtensions {
  extensions .protobuf_unittest.TestPackedExtensions.$extensions.174 {
  extensionrange 1 to 536870911
  }
}
extend .protobuf_unittest.$extend.175 {
