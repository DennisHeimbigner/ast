...
message .protobuf_unittest.TestAllExtensions {
  extensions .protobuf_unittest.TestAllExtensions.$extensions.39 {
  extensionrange 1 to 536870911
  }
}
extend .protobuf_unittest.$extend.40 {
...
message .protobuf_unittest.TestNestedExtension {
  extend .protobuf_unittest.TestNestedExtension.$extend.41 {
...
message .protobuf_unittest.TestRequired {
  ...
  extend .protobuf_unittest.TestRequired.$extend.42 {
...
message .protobuf_unittest.TestEmptyMessageWithExtensions {
  extensions .protobuf_unittest.TestEmptyMessageWithExtensions.$extensions.43 {
  extensionrange 1 to 536870911
  }
}
message .protobuf_unittest.TestMultipleExtensionRanges {
  extensions .protobuf_unittest.TestMultipleExtensionRanges.$extensions.44 {
  extensionrange 42 to 536870911
  }
  extensions .protobuf_unittest.TestMultipleExtensionRanges.$extensions.45 {
  extensionrange 4143 to 4243
  }
  extensions .protobuf_unittest.TestMultipleExtensionRanges.$extensions.46 {
...
message .protobuf_unittest.TestPackedExtensions {
  extensions .protobuf_unittest.TestPackedExtensions.$extensions.50 {
  extensionrange 1 to 536870911
  }
}
extend .protobuf_unittest.$extend.51 {
