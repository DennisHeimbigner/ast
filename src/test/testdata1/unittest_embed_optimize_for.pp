...
package .protobuf_unittest_embed_optimize;
import unittest_optimize_for.proto;
option .protobuf_unittest_embed_optimize.optimize_for = SPEED;
message .protobuf_unittest_embed_optimize.TestEmbedOptimizedForSize {
  optional .protobuf_unittest_optimize.TestOptimizedForSize .protobuf_unittest_embed_optimize.TestEmbedOptimizedForSize.optional_message = 1;
  repeated .protobuf_unittest_optimize.TestOptimizedForSize .protobuf_unittest_embed_optimize.TestEmbedOptimizedForSize.repeated_message = 2;
}
package .protobuf_unittest_optimize;
import unittest.proto;
option .protobuf_unittest_optimize.optimize_for = CODE_SIZE;
message .protobuf_unittest_optimize.TestOptimizedForSize {
  optional int32 .protobuf_unittest_optimize.TestOptimizedForSize.i = 1;
  optional .protobuf_unittest.ForeignMessage .protobuf_unittest_optimize.TestOptimizedForSize.msg = 19;
  extensions .protobuf_unittest_optimize.TestOptimizedForSize.$extensions.100 {
  extensionrange 1000 to 536870911
  }
  extend .protobuf_unittest_optimize.TestOptimizedForSize.$extend.101 {
    optional int32 .protobuf_unittest_optimize.TestOptimizedForSize.$extend.test_extension = 1234;
    optional .protobuf_unittest_optimize.TestRequiredOptimizedForSize .protobuf_unittest_optimize.TestOptimizedForSize.$extend.test_extension2 = 1235;
  }
}
message .protobuf_unittest_optimize.TestRequiredOptimizedForSize {
  required int32 .protobuf_unittest_optimize.TestRequiredOptimizedForSize.x = 1;
}
message .protobuf_unittest_optimize.TestOptionalOptimizedForSize {
  optional .protobuf_unittest_optimize.TestRequiredOptimizedForSize .protobuf_unittest_optimize.TestOptionalOptimizedForSize.o = 1;
}
...
message .protobuf_unittest.TestAllExtensions {
  extensions .protobuf_unittest.TestAllExtensions.$extensions.87 {
  extensionrange 1 to 536870911
  }
}
extend .protobuf_unittest.$extend.88 {
...
message .protobuf_unittest.TestNestedExtension {
  extend .protobuf_unittest.TestNestedExtension.$extend.89 {
...
message .protobuf_unittest.TestRequired {
  ...
  extend .protobuf_unittest.TestRequired.$extend.90 {
...
message .protobuf_unittest.TestEmptyMessageWithExtensions {
  extensions .protobuf_unittest.TestEmptyMessageWithExtensions.$extensions.91 {
  extensionrange 1 to 536870911
  }
}
message .protobuf_unittest.TestMultipleExtensionRanges {
  extensions .protobuf_unittest.TestMultipleExtensionRanges.$extensions.92 {
  extensionrange 42 to 536870911
  }
  extensions .protobuf_unittest.TestMultipleExtensionRanges.$extensions.93 {
  extensionrange 4143 to 4243
  }
  extensions .protobuf_unittest.TestMultipleExtensionRanges.$extensions.94 {
...
message .protobuf_unittest.TestPackedExtensions {
  extensions .protobuf_unittest.TestPackedExtensions.$extensions.98 {
  extensionrange 1 to 536870911
  }
}
extend .protobuf_unittest.$extend.99 {
