...
PrimRepeated_write(ast_runtime* rt, PrimRepeated* primrepeated_v)
{
    ...
    {
        status = ast_write_primitive_packed(rt,ast_int32,1,&primrepeated_v->f_int32);
    }
    {
        int i = 0;
    ...
    {
        status = ast_write_primitive_packed(rt,ast_uint32,3,&primrepeated_v->f_uint32);
    }
    {
        int i = 0;
    ...
    {
        status = ast_write_primitive_packed(rt,ast_sint32,5,&primrepeated_v->f_sint32);
    }
    {
        int i = 0;
    ...
    {
        status = ast_write_primitive_packed(rt,ast_fixed32,7,&primrepeated_v->f_fixed32);
    }
    {
        int i = 0;
    ...
    {
        status = ast_write_primitive_packed(rt,ast_sfixed32,9,&primrepeated_v->f_sfixed32);
    }
    {
        int i = 0;
    ...
    {
        status = ast_write_primitive_packed(rt,ast_double,11,&primrepeated_v->f_double);
    }
    {
        int i = 0;
...
PrimRepeated_read(ast_runtime* rt, PrimRepeated** primrepeated_vp)
{
    ...
    while(status == AST_NOERR) {
        ...
        switch (fieldno) {
        case 1: {
            status = ast_read_primitive_packed(rt,ast_int32,1,&primrepeated_v->f_int32);
            if(status != AST_NOERR) {ACATCH(status); goto done;}
            } break;
        case 2: {
            int64_t tmp;
        ...
        case 3: {
            status = ast_read_primitive_packed(rt,ast_uint32,3,&primrepeated_v->f_uint32);
            if(status != AST_NOERR) {ACATCH(status); goto done;}
            } break;
        case 4: {
            uint64_t tmp;
        ...
        case 5: {
            status = ast_read_primitive_packed(rt,ast_sint32,5,&primrepeated_v->f_sint32);
            if(status != AST_NOERR) {ACATCH(status); goto done;}
            } break;
        case 6: {
            int64_t tmp;
        ...
        case 7: {
            status = ast_read_primitive_packed(rt,ast_fixed32,7,&primrepeated_v->f_fixed32);
            if(status != AST_NOERR) {ACATCH(status); goto done;}
            } break;
        case 8: {
            uint64_t tmp;
        ...
        case 9: {
            status = ast_read_primitive_packed(rt,ast_sfixed32,9,&primrepeated_v->f_sfixed32);
            if(status != AST_NOERR) {ACATCH(status); goto done;}
            } break;
        case 10: {
            int64_t tmp;
        ...
        case 11: {
            status = ast_read_primitive_packed(rt,ast_double,11,&primrepeated_v->f_double);
            if(status != AST_NOERR) {ACATCH(status); goto done;}
            } break;
        case 12: {
            float tmp;
...
PrimRepeated_get_size(ast_runtime* rt, PrimRepeated* primrepeated_v)
{
...

    {
        ...
        for(i=0;i<primrepeated_v->f_int32.count;i++) {
            fieldsize += ast_get_tagsize(rt,ast_int32,1);
    ...
    }
    {
        ...
        for(i=0;i<primrepeated_v->f_uint32.count;i++) {
            fieldsize += ast_get_tagsize(rt,ast_uint32,3);
    ...
    }
    {
        ...
        for(i=0;i<primrepeated_v->f_sint32.count;i++) {
            fieldsize += ast_get_tagsize(rt,ast_sint32,5);
    ...
    }
    {
        ...
        for(i=0;i<primrepeated_v->f_fixed32.count;i++) {
            fieldsize += ast_get_tagsize(rt,ast_fixed32,7);
    ...
    }
    {
        ...
        for(i=0;i<primrepeated_v->f_sfixed32.count;i++) {
            fieldsize += ast_get_tagsize(rt,ast_sfixed32,9);
    ...
    }
    {
        ...
        for(i=0;i<primrepeated_v->f_double.count;i++) {
            fieldsize += ast_get_tagsize(rt,ast_double,11);
